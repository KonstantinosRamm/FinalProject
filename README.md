...
2. ```bash git clone https://github.com/KonstantinosRamm/FinalProject.git ```
3. ```bash cd FinalProject/Hangman ```
4. ```bash make or make hangman ```
5. run the game with: ```bash ./hangman ```
